# Using multi-dimensional logistic regression for classification
...
x1_label1 = np.random.normal(4, 1, 1000)
x2_label1 = np.random.normal(3, 1, 1000)
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        current_cost, _ = sess.run([cost, train_op], feed_dict={X1: x1s, X2: x2s, Y: ys})
        if epoch % 100 == 0:
